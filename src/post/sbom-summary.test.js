...
describe('parseSBOMEntries', () => {
    ...
    it('handles real-world cimon log format with extra fields', () => {
        ...
        const output = JSON.stringify({
            ...
            msg: 'SBOM files written',
            cyclonedx:
                '/data/home/runner/work/proj/proj/build-logalyzer/sbom.cdx.json',
            spdx: '/data/home/runner/work/proj/proj/build-logalyzer/sbom.spdx.json',
            artifact: 'logalyzer',
            components: 42,
        });
        ...
        assert.equal(
            entries[0].spdx,
            '/data/home/runner/work/proj/proj/build-logalyzer/sbom.spdx.json'
        );
    });
});
